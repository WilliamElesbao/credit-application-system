...
class CreditServiceTest {
    ...
    fun `should not create credit when invalid day first installment`() {
        ...
        // when
        val exception = assertThrows<MaxThreeMonthsAfterCurrentDateException> {
            creditService.save(credit)
        }

        // then
        val expectedMessage = "A data da primeira parcela deve ser no máximo 3 meses após o dia atual"
